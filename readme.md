...
I repaired a Nikon F100 film camera sold for-parts.
For my camera, an internal cleaning was all that was actually needed to get it working.
...
- Eyepiece
    ...
    - It is a very simple part. Metal aftermarket versions are currently manufactured and cost $12 shipped. 
...
I followed the “Disassembly 1. Exterior" section of the F100 repair manual. 
Also helpful are the afotandovy photographs up to and not including removal of the LCD screen’s screws. 
...
- A window at the ceiling of the battery compartment exposes a spring-loaded contact. Normally a peg on the MS-12 battery cartridge pushes the switch open, indicating to the body that 4xAA power is expected. A plausible explanation for symptom 2 is that corrosion interfered with this switch opening, thus the body expected a higher voltage from an MS-15 6xAA (The MS-15 has an additional peg compared to the MS-12). Very fresh batteries could have put the MS-12's 4xAA just above the failure threshold for MS-15, causing intermittent failures. See Figure 4, white arrow pointing at the contact unique to the MS-15. In the repair manual A-31 and R-5 list relevant voltage ranges.
